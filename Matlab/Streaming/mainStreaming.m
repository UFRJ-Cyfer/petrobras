...
% path = 'J:';
inicialFile = [1 1 1 0 0 1 1 1 604];
finalFile = [754 400 360 0 0 1 1 1 604];
...
if readFiles == 1
    ...
    save(['bitsPerChannelCP2Ciclo_' num2str(cpNumber)],'numBitsFileChannel','numUniqueElementsChannel')
    end
    %saving struct
end
...
CPtoExaminate = {'bitsPerChannelCP2_Ciclo1','bitsPerChannelCP2_Ciclo1_2','bitsPerChannelCP3','bitsPerChannelCP4',};

     
    files = {'idr2_02_ciclo_1#','idr2_02_ciclo_1_2#','IDR2_ensaio_03#','ciclo_2#'};
    paths = {'J:\EnsaioIDR02-2\SegundoTuboStreaming', 'J:\EnsaioIDR02-2\SegundoTuboStreaming', 'L:\CP3\Ciclo1','M:\CP4-24.05.2016\Ciclo2-1de1'};
    desc = {'CP2_Ciclo_1', 'CP2_Ciclo_2', 'CP3_Ciclo_1','CP4_Ciclo_2'};
...
%             streamingStruct(k).startingTime(startingColumn:endColumn) = (filesToCheck(l)-1)*(fileLength/fs)*ones(1,endColumn-startingColumn+1);
     ...
     save(['streamingStruct' desc{k}],'streamingStruct','-v7.3')
end
