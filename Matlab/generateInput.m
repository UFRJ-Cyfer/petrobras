function [neuralNetInput, chosenFrequencies, indexesChosenFrequencies] = generateInput(rawInput, frequencyDivisions, corrFigHandle, greenFrequencies, greenValues, frequencyVector)
