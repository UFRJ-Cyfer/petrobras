function [neuralNetInput, indexesChosenFrequencies] = generateInput(rawInput, frequencyDivisions, corrFigHandle, frequencyVector)
...
% validFrequencies = 1*(f_1 | f_2 | f_3);
...
hold on;
D=get(clickedAx,'Children'); %get the handle of the line object
XData=get(D,'XData'); %get the x data
YData=get(D,'YData'); %get the y data

greenFrequencies = XData{1};
greenValues = YData{1};
